...
char ssid[] = "killempest";
char pass[] = "williamtan";
char auth[] = "2fa827491cad45669ffc62e3559915e2";
char serialnum[] = "Accelerometer 10";
...
adxl.ActivityINT(1);
 ...
 adxl.setSpiBit(5);
  ...
  adxl.setTapThreshold(5);           // 62.5 mg per increment
    ...
    */
    ...
    if (bootCount == 0) {
      if (client.connect("maker.ifttt.com", 80)) {
        ...
        Blynk.run();
        Blynk.email("Smartrodent2018@gmail.com", serialnum, "Trap Activated!");
      ...
      Blynk.run();
      Blynk.email("Smartrodent2018@gmail.com", serialnum, "Rodent Caught!");
